...
def fetch_complete_league_data(league):
    """
    Unblockable Custom Global Registry Database for Mockinbird AI
    Optimized for 16 WNBA Franchises and Domestic European Basketball Leagues.
    """
    if league == "NBA":
        return pd.DataFrame({
            "Team": [
        ...
        # Expanded 16-Team Roster (Includes current teams, expansion teams, and future additions)
        return pd.DataFrame({
            "Team": [
            ...
            "GP": [40]*16,
            "PTS": [86.5, 87.8, 82.3, 80.1, 83.4, 84.8, 81.5, 77.2, 78.8, 79.1, 78.4, 81.8, 82.1, 80.5, 79.8, 81.0],
            "Opp_PTS": [76.5, 81.2, 75.8, 73.4, 78.9, 87.3, 84.8, 80.3, 82.5, 82.7, 86.1, 86.9, 81.5, 81.0, 82.2, 83.0],
            "FGA": [68.2, 69.1, 66.5, 64.2, 70.3, 68.8, 66.2, 67.5, 69.0, 66.0, 66.9, 71.1, 67.9, 66.8, 67.2, 68.0],
            "FTA": [16.8, 19.5, 15.2, 18.1, 15.9, 17.5, 18.0, 18.2, 16.5, 15.9, 17.0, 19.1, 17.2, 16.9, 17.4, 17.0],
            "ORB": [8.1, 6.9, 7.8, 8.5, 9.4, 7.5, 6.5, 8.0, 10.1, 7.0, 7.2, 10.5, 8.2, 7.9, 8.4, 8.0],
            "TOV": [12.7, 11.2, 13.4, 12.1, 13.0, 14.4, 13.5, 12.9, 13.9, 14.1, 14.8, 12.3, 13.2, 13.5, 14.0, 13.1],
            "Opp_FGA": [69.4, 69.8, 67.2, 63.9, 71.0, 71.2, 69.1, 67.3, 68.4, 66.5, 69.3, 70.5, 68.1, 67.9, 68.2, 68.5],
            "Opp_FTA": [14.1, 15.5, 14.8, 16.0, 15.1, 17.0, 18.2, 16.9, 17.2, 18.0, 17.9, 19.5, 16.2, 16.8, 17.0, 17.2],
            "Opp_ORB": [7.9, 8.6, 8.1, 7.7, 9.1, 8.5, 8.2, 8.8, 9.5, 8.0, 9.0, 9.8, 8.6, 8.3, 8.9, 8.7],
            "Opp_TOV": [14.5, 12.6, 15.1, 14.9, 14.2, 11.9, 12.6, 12.2, 13.1, 14.5, 12.4, 12.8, 13.0, 12.8, 12.5, 13.2],
            "MIN": [40.0]*16
        })
        
    else:
        # European National Leagues (Top franchises from Spain's ACB, Germany's BBL, France's LNB, Italy's LBA, etc.)
        return pd.DataFrame({
            "Team": [
                "Real Madrid (Spain)", "Unicaja Malaga (Spain)", "FC Barcelona (Spain)", "Valencia Basket (Spain)",
                "Bayern Munich (Germany)", "Alba Berlin (Germany)", "Telekom Baskets Bonn (Germany)",
                "AS Monaco (France)", "Paris Basketball (France)", "ASVEL Villeurbanne (France)",
                "Virtus Bologna (Italy)", "Olimpia Milano (Italy)", "Reyer Venezia (Italy)",
                "Panathinaikos (Greece)", "Olympiacos (Greece)", "Fenerbahce (Turkey)",
                "Anadolu Efes (Turkey)", "Maccabi Tel Aviv (Israel)"
            ],
            "GP": [34]*18,
            "PTS": [88.5, 84.2, 83.9, 81.4, 85.1, 80.2, 82.6, 86.9, 85.4, 81.0, 83.2, 80.9, 79.1, 86.2, 84.7, 85.3, 86.0, 87.4],
            "Opp_PTS": [79.2, 76.5, 78.4, 77.1, 78.9, 82.4, 81.0, 78.1, 79.9, 80.5, 78.6, 76.1, 78.2, 77.4, 75.8, 79.0, 80.3, 85.9],
            "FGA": [64.8, 62.1, 62.5, 61.0, 63.4, 61.2, 62.0, 64.1, 63.8, 61.9, 62.4, 60.5, 60.1, 63.0, 61.5, 62.8, 63.1, 65.0],
            "FTA": [18.2, 17.9, 17.1, 18.5, 18.0, 16.4, 17.2, 19.1, 18.4, 17.0, 18.1, 17.4, 16.9, 19.5, 18.8, 18.2, 18.5, 19.9],
            "ORB": [9.5, 9.1, 8.8, 9.2, 10.1, 8.5, 9.0, 10.2, 9.4, 8.9, 9.1, 8.6, 8.4, 9.2, 9.6, 9.3, 8.9, 10.8],
            "TOV": [11.5, 12.1, 12.0, 12.8, 11.9, 13.5, 12.4, 11.0, 11.8, 12.5, 12.2, 11.7, 12.6, 12.0, 11.6, 12.1, 11.4, 12.3],
            "Opp_FGA": [65.2, 61.8, 61.9, 60.4, 62.9, 62.1, 61.5, 62.7, 63.0, 61.1, 61.4, 59.8, 60.5, 62.1, 60.9, 61.7, 62.0, 64.5],
            "Opp_FTA": [15.4, 16.1, 15.9, 16.5, 16.8, 17.2, 16.5, 17.4, 17.0, 16.9, 16.3, 15.8, 16.2, 16.8, 16.0, 16.9, 17.1, 18.2],
            "Opp_ORB": [9.0, 8.7, 8.9, 9.0, 9.6, 9.2, 9.1, 9.5, 9.3, 9.1, 8.8, 8.4, 8.9, 8.7, 8.5, 8.9, 9.1, 10.2],
            "Opp_TOV": [13.1, 12.9, 12.5, 13.2, 12.7, 12.1, 12.8, 12.4, 12.2, 13.1, 12.9, 12.5, 12.1, 13.4, 12.8, 12.6, 12.3, 12.9],
            "MIN": [40.0]*18
        })
...
def calculate_advanced_stats(df, league):
    ...
    reg_min = 40.0 if league in ["WNBA", "Euro Basketball Leagues"] else 48.0
...
selected_league = st.sidebar.selectbox("Select Competition League", ["NBA", "WNBA", "Euro Basketball Leagues"])
