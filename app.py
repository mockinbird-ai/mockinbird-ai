...
def fetch_complete_league_data(league_selection):
    ...
    if league_selection == "NBA":
        return pd.DataFrame({
            ...
            "Opp_ORB": [10.0, 11.5, 9.8, 9.5, 10.4, 10.1, 9.3, 10.2, 10.5, 9.7, 10.5, 10.3, 10.2, 9.8, 10.1, 9.6, 10.9, 11.1, 10.5, 11.3, 10.8, 11.2, 11.0, 11.1, 10.8, 10.4, 10.5],
...
if team_a != team_b:
    if st.button("Run Advanced Matchup Simulation", type="primary"):
        ...
        st.markdown("---")
        st.header(f"🦅 Prediction Result: {w
